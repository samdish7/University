    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        switch (getItemViewType(position)) {
            ...
            case 6:
                ...
                break;
            case 7:
                ContactListItem cli = (ContactListItem) list.get(position);
                convertView = cli.getView();
                break;
            case 8:
                SubjectListItem sli = (SubjectListItem) list.get(position);
                convertView = sli.getView();
                break;
            case 9:
                HomeListItem hli = (HomeListItem) list.get(position);
                convertView = hli.getView();
                break;
            case 10:
                CalendarListItem cali = (CalendarListItem) list.get(position);
                convertView = cali.getView();
                break;
            case 11:
                AlertListItem ali = (AlertListItem) list.get(position);
                convertView = ali.getView();
                break;
        }
        return convertView;
    }
